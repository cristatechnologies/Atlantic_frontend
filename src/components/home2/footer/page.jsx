          ...
          <div className="row">
            ...
            <div className="col-lg-2 col-md-6">
              <div className="footer-widget footer-menu">
                ...
                <ul>
                  <li>
                    <Link href ="about.html">Our product</Link>
                  </li>
                  <li>
                    <Link href ="javascript:void(0)">Documentation</Link>
                  </li>
                  <li>
                    <Link href ="service-details.html">Our Services</Link>
                  </li>
                  <li>
                    <Link href ="javascript:void(0)">Get Started Us</Link>
                  </li>
                  <li>
            ...
            <div className="col-lg-2 col-md-6">
              <div className="footer-widget footer-menu">
                ...
                <ul>
                  <li>
                    <Link href ="javascript:void(0)">Market Place</Link>
                  </li>
                  <li>
                    <Link href ="javascript:void(0)">Documentation</Link>
                  </li>
                  <li>
                    <Link href ="javascript:void(0)">Customers</Link>
                  </li>
                  <li>
                    <Link href ="javascript:void(0)">Carriers</Link>
                  </li>
                  <li>
                    <Link href ="blog-list.html">Our Blog</Link>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-lg-2 col-md-6">
              <div className="footer-widget footer-menu">
                ...
                <ul>
                  <li>
                    <Link href ="javascript:void(0)">Manhatten</Link>
                  </li>
                  <li>
                    <Link href ="javascript:void(0)">Los Angeles</Link>
                  </li>
                  <li>
                    <Link href ="javascript:void(0)">Houston</Link>
                  </li>
                  <li>
                    <Link href ="javascript:void(0)">Chicago</Link>
                  </li>
                  <li>
                    <Link href ="javascript:void(0)">Alabama</Link>
                  </li>
                </ul>
              </div>
            </div>
