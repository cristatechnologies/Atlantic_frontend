  ...
  return (
    ...
    <div className="main-wrapper">
      ...
      <section className="banner-section banner-section-two">
        <img src="./img/bannerbg.png" className="img-fluid" alt="bannercircle" />
          ...
          <div className="row">
            <div className="col-md-12 aos" data-aos="fade-up">
              <div className="section-heading-two text-center">
                ...
                <img src="./img/title-img.png" className="img-fluid" alt="title-img" />
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col-lg-5 col-md-6">
              <div className="wedding-wrap aos" data-aos="fade-up">
                ...
                <div className="wedding-content">
                  <h6>
                    <Link href ="/categories">Venues</Link>
                  </h6>
                  <p>
              ...
              <div className="wedding-wrap aos" data-aos="fade-up">
                ...
                <div className="wedding-content">
                  <h6>
                    <Link href ="/categories">Photographers</Link>
                  </h6>
                  <p>
              ...
              <div className="wedding-wrap aos" data-aos="fade-up">
                ...
                <div className="wedding-content">
                  <h6>
                    <Link href ="/categories">Groom and Bridal Makeup</Link>
                  </h6>
                  <p>
            ...
            <div className="col-lg-5 col-md-6 aos" data-aos="fade-up">
              <div className="wedding-wrap wedding-align">
                <div className="wedding-content">
                  <h6>
                    <Link href ="/categories">Groom and Bride Wear</Link>
                  </h6>
                  <p>
              ...
              >
                <div className="wedding-content">
                  <h6>
                    <Link href ="/categories">Mehandi</Link>
                  </h6>
                  <p>
                    Banquet Halls, Lawns / Farmhouses, Resorts, Small Function /
                    Party Halls, Destination Wedding, Kalyan Mandapam, 4 Star &
              ...
              >
                <div className="wedding-content">
                  <h6>
                    <Link href ="/categories">Catering</Link>
                  </h6>
                  <p>
                    Banquet Halls, Lawns / Farmhouses, Resorts, Small Function /
                    Party Halls, Destination Wedding, Kalyan Mandapam, 4 Star &
      ...
      <section className="offer-section">
        <div className="container">
          <div className="offer-sec">
            ...
            <Link href ="/contact" className="btn btn-grey">
              Contact Now
            </Link>
        ...
        <div className="container">
          <div className="vendor-sec">
            <div className="vendor-info aos" data-aos="fade-up">
              ...
              <Link href ="/signup" className="btn btn-grey">
