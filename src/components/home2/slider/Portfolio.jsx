                ...
                <div className="row gx-2 bg-white port-wrap">
                  <div className="col-md-3 col-sm-6">
                    <div className="portfolio-item">
                      ...
                      <div className="portfolio-overlay-item">
                        <Link href ={Gallery01} data-fancybox="gallery1">
                    ...
                    <div className="portfolio-item">
                      ...
                      <div className="portfolio-overlay-item">
                        <Link href ={Gallery02} data-fancybox="gallery1">
                          <div className="portfolio-overlay">
                            <h6>Wedding Venues</h6>
                  ...
                  <div className="col-md-3 col-sm-6">
                    <div className="portfolio-item">
                      ...
                      <div className="portfolio-overlay-item">
                        <Link href ={Gallery03} data-fancybox="gallery1">
                          <div className="portfolio-overlay">
                            <h6>Wedding Venues</h6>
                    ...
                    <div className="row gx-2">
                      <div className="col-md-6">
                        <div className="portfolio-item">
                          ...
                          <div className="portfolio-overlay-item">
                            <Link href ={Gallery04} data-fancybox="gallery1">
                              <div className="portfolio-overlay">
                                <h6>Wedding Venues</h6>
                      ...
                      <div className="col-md-6">
                        <div className="portfolio-item">
                          ...
                          <div className="portfolio-overlay-item">
                            <Link href ={Gallery05} data-fancybox="gallery1">
                              <div className="portfolio-overlay">
                                <h6>Wedding Venues</h6>
                      ...
                      <div className="col-md-12">
                        <div className="portfolio-item">
                          ...
                          <div className="portfolio-overlay-item">
                            <Link href ={Gallery06} data-fancybox="gallery1">
                              <div className="portfolio-overlay">
                                <h6>Wedding Venues</h6>
                                <p>155 Photos and 5 Videos</p>
                              </div>
