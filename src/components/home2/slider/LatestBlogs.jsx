          ...
          <div className="col-lg-12">
            ...
            <Slider {...settings} className=" blog-slider">
              <div className="blog grid-blog blog-two aos" data-aos="fade-up">
                ...
                <div className="blog-content">
                  <h3 className="blog-title">
                    <Link href ="/blog-details">Wedding Tips For Fashion</Link>
                  </h3>
              ...
              <div className="blog grid-blog blog-two aos" data-aos="fade-up">
                ...
                <div className="blog-content">
                  <h3 className="blog-title">
                    <Link href ="/blog-details">Pre-Wedding Photoshoot</Link>
                  </h3>
                  <ul className="entry-meta meta-item">
                    <li className="date-icon">
              ...
              <div className="blog grid-blog blog-two aos" data-aos="fade-up">
                ...
                <div className="blog-content">
                  <h3 className="blog-title">
                    <Link href ="/blog-details">Special Food wedding</Link>
                  </h3>
                  <ul className="entry-meta meta-item">
                    <li className="date-icon">
