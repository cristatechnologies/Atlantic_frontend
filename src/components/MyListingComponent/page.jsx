  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record, data) => (
        <>
          <h6>
            <Link href="/service-details">{text}</Link>
          </h6>
          <div className="listingtable-rate">
            <Link href="#" className="cat-icon">
    ...
    },
    {
      ...
      render: (text, record, data) => (
        <div className={text}>
          <Link href="#" className="action-btn btn-view">
            <i className="feather-eye" />
          </Link>
          <Link href="#" className="action-btn btn-edit">
            <i className="feather-edit-3" />
          </Link>
          <Link href="#" className="action-btn btn-trash">
