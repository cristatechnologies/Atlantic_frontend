...
const Home9 = () => {
      ...
      <div className="main-wrapper home-nine">
        ...
        <section className="featured-listing-section common-padding">
          <div className="footer-six-bg footer-nine-bg">
            <img src= "./img/bg/feature-bg.png" alt="" />
          </div>
          <div className="container">
            <div
  ...
  <section className="premium-and-essential-services common-padding position-relative">
    <div className="preminum-float-bg">
      <img src= "./img/bg/premium-bg.png" alt="" />
    </div>
    <div className="container">
      <div className="row">
        <div className="col-md-12">
  ...
  <section className="make-it-easy common-padding">
    <div className="container">
      ...
      <Link href ="/categories">Search Properties</Link>
    </div>
  </section>
  {/* /Make It Easy */}
      ...
      <div className="row">
          ...
          <div className="owner-card">
            ...
            <div className="owner-info">
              <div className="owner-name">
                <Link href ="/profile">Jonny baristow</Link>
        ...
        >
          <div className="owner-card">
            ...
            <div className="owner-info">
              <div className="owner-name">
                <Link href ="/profile">Angeline Marshall</Link>
                <span className="double-tick">
                  <i className="fa-solid fa-check-double" />
                </span>
              </div>
        ...
        >
          <div className="owner-card">
            ...
            <div className="owner-info">
              <div className="owner-name">
                <Link href ="/profile">Abraham Musol</Link>
                <span className="double-tick">
                  <i className="fa-solid fa-check-double" />
                </span>
              </div>
        ...
        >
          <div className="owner-card">
            ...
            <div className="owner-info">
              <div className="owner-name">
                <Link href ="/profile">Rayon Akram</Link>
                <span className="double-tick">
                  <i className="fa-solid fa-check-double" />
                </span>
              </div>
        ...
        <div className="col-md-12 text-center">
          <Link href ="/listingmap-list" className="verified-owner-list-btn">
            View all Owners
          </Link>
        </div>
      </div>
  ...
  <section className="buy-property aos" data-aos="fade-up">
    <div className="container">
      <div className="buy-property-content">
        ...
        <Link href ="/my-listing">List Your Space</Link>
      </div>
    </div>
  </section>
  {/* /Join Us */}
      ...
      <div className="row align-items-center aos" data-aos="fade-up">
        ...
        <div className="col-lg-6 col-md-12">
          <div className="join-as-dealer-btn">
            <Link href ="/signup">View all Prroperties</Link>
          </div>
        </div>
      </div>
    </div>
          ...
          <div className="col-lg-6 col-md-12">
            <div className="footer-six-center foot-nine-list">
              <div className="footer-six-center-content">
                ...
                <Link href ="#">4,56,6597</Link>
              </div>
              <div className="footer-six-center-content">
                <h6>Need live support?</h6>
                <Link href ="#">listee@example.com</Link>
              </div>
              <div className="footer-six-center-content">
                <h6>Toll Free Customer Care</h6>
                <Link href ="#">+91 26447 99875</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-2 col-md-6 col-sm-12">
          <div className="footer-six-top-list">
            ...
            <ul>
              ...
              <li>
                <Link href ="/privacy-policy">User’s Guide</Link>
              </li>
              <li>
                <Link href ="/contact">Support Center</Link>
              </li>
              <li>
                <Link href ="/about">Press Info</Link>
              </li>
              <li>
