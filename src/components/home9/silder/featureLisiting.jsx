        ...
        <OwlCarousel {...settings} className="real-featured-listing owl-carousel owl-theme">
              <div className="feature-rent">
                <div className="feature-home-img">
                  <Link href ="/listingmap-list">
                    <img
                      src= "./img/featured/property-feature-1.jpg"}
                      className="img-fluid"
                      alt=""
                    />
                  </Link>
                ...
                <div className="green-logo">
                  <img
                    src= "./img/featured/feature-text-logo.png"
                    className="img-fluid"
                    alt=""
                  />
                </div>
              ...
              <div className="feature-rent">
                <div className="feature-home-img">
                  <Link href ="/listingmap-list">
                    <img
                      src= "./img/featured/property-feature-2.jpg"
                      className="img-fluid"
                      alt=""
                    />
                  </Link>
              ...
              <div className="feature-rent">
                <div className="feature-home-img">
                  <Link href ="/listingmap-list">
                    <img
                      src= "./img/featured/property-feature-3.jpg"
                      className="img-fluid"
                      alt=""
                    />
                  </Link>
