    ...
    <div className="container">
      ...
      <div className="category-details">
        ...
        <div className="align-items-center justify-content-center d-flex">
          <Link href ="listing-grid-sidebar" className="category-btn">
            View All Category
          </Link>
        </div>
      </div>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6 aos" data-aos="fade-up">
            <div className="vacancies-box">
              <div className="vacancies-top">
                ...
                <Link href ="#" className="fav-icon-top">
              ...
              <div className="vacancies-inner">
                ...
                <div className="vacancies-content">
                  <h4>
                    <Link href ="/categories">Technical Support Engineer</Link>
                  </h4>
              ...
              <div className="vaca-footer">
                ...
                <div className="footer-btn">
                  <Link href ="/categories" className="btn-view">
                    Apply Now
                  </Link>
                </div>
              </div>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6 aos" data-aos="fade-up">
            <div className="vacancies-box">
              ...
              <div className="vacancies-inner">
                ...
                <div className="vacancies-content">
                  <h4>
                    <Link href ="/categories">Android Developer </Link>
                  </h4>
                  <div className="vaca-location">
                    <p>Company Name</p>
                    <p className="light-color">|</p>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6 aos" data-aos="fade-up">
            <div className="vacancies-box">
              ...
              <div className="vacancies-inner">
                ...
                <div className="vacancies-content">
                  <h4>
                    <Link href ="/categories">Junior Graphic Designer</Link>
                  </h4>
                  <div className="vaca-location">
                    <p>Company Name</p>
                    <p className="light-color">|</p>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6 aos" data-aos="fade-up">
            <div className="vacancies-box">
              ...
              <div className="vacancies-inner">
                ...
                <div className="vacancies-content">
                  <h4>
                    <Link href ="/categories">Product Sales Specialist</Link>
                  </h4>
                  <div className="vaca-location">
                    <p>Company Name</p>
                    <p className="light-color">|</p>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6 aos" data-aos="fade-up">
            <div className="vacancies-box">
              ...
              <div className="vacancies-inner">
                ...
                <div className="vacancies-content">
                  <h4>
                    <Link href ="/categories">General Ledger Accountant</Link>
                  </h4>
                  <div className="vaca-location">
                    <p>Company Name</p>
                    <p className="light-color">|</p>
            ...
            <div className="popular-box">
              ...
              <div className="popular-inner">
                ...
                <div className="popular-content ">
                  <h4>
                    {" "}
                    <Link href ="/categories"> Digital Marketer</Link>
                  </h4>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6 aos" data-aos="fade-up">
            <div className="popular-box">
              ...
              <div className="popular-inner">
                ...
                <div className="popular-content">
                  <h4>
                    <Link href ="/categories"> IT Support Associate </Link>
                  </h4>
                  <div className="popular-location">
                    <p>Company Name</p>
                    <p className="light-color">|</p>
        ...
        <div className="col-lg-6 col-md-12 col-sm-6 aos" data-aos="fade-up">
          <div className="adv-box adv-bg-two">
            ...
            <div className="adv-content">
              ...
              <div className="adver-btn">
                <Link href ="#" className="btn-primary btn-dark">
                  Register Account
                </Link>
              </div>
            </div>
  ...
  <section className="blog-eight-section">
    <div className="container">
      ...
      <div
        ...
        data-aos="fade-up"
      >
        <Link href ="/blog-details" className="category-btn">
          View All Category
        </Link>
      </div>
    </div>
          ...
          <div className="right-ads">
            <div className="ads-content">
              ...
              <div className="advs-btn">
                <Link href ="/contact">Upload your CV</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-2 col-md-6 aos" data-aos="fade-up">
            ...
            <div className="footer-widget footer-menu">
              ...
              <ul>
                ...
                <li>
                  <Link href ="javascript:void(0)">Press</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">News</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">Media Kit</Link>
                </li>
                <li>
          ...
          <div className="col-lg-2 col-md-6 aos" data-aos="fade-up">
            ...
            <div className="footer-widget footer-menu">
              ...
              <ul>
                <li>
                  <Link href ="javascript:void(0)">Overview</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">Features</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">Solutions</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">Tutorials</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">Pricing</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">Releases</Link>
                </li>
              </ul>
            </div>
            {/* /Footer Widget */}
          ...
          <div className="col-lg-2 col-md-6 aos" data-aos="fade-up">
            ...
            <div className="footer-widget footer-menu">
              ...
              <ul>
                ...
                <li>
                  <Link href ="javascript:void(0)">Newsletter</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">Events</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">Help Centre</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">Tutorials</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">Support</Link>
                </li>
              </ul>
            </div>
            {/* /Footer Widget */}
          ...
          <div className="col-lg-2 col-md-6 aos" data-aos="fade-up">
            ...
            <div className="footer-widget footer-menu">
              ...
              <ul>
                <li>
                  <Link href ="javascript:void(0)">Twitter</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">LinkedIn </Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">Facebook</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">GitHub</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">AngelList</Link>
                </li>
                <li>
                  <Link href ="javascript:void(0)">Dribble</Link>
                </li>
              </ul>
            </div>
            {/* /Footer Widget */}
