...
const HomeMenu = ({ activeMenu }) => {
  ...
  return (
    <li className="has-submenu megamenu ">
      <Link href ="" className={menu1 ? 'submenu' : ""}>
              ...
              <div className="col-lg-2">
                ...
                >
                  <div className="demo-img">
                    <Link href ="/index">
                      <img src= "./img/home-01.jpg" className="img-fluid" alt="img" />
                    </Link>
                  </div>
                  <div className="demo-info">
                    <Link href ="/index">classNameified Home</Link>
                  </div>
                </div>
              </div>
              <div className="col-lg-2">
                ...
                >
                  <div className="demo-img">
                    <Link href ="/index-2">
                      <img src= "./img/home-02.jpg" className="img-fluid" alt="img" />
                    </Link>
                  </div>
                  <div className="demo-info">
