              ...
              <div className="blog-widget">
                ...
                <div className="bloglist-content">
                  <div className="card-body">
                    ...
                    <h6>
                      <Link href ="/service-details">Cinema</Link>
                    </h6>
              ...
              <div className="blog-widget">
                ...
                <div className="bloglist-content">
                  <div className="card-body">
                    ...
                    <h6>
                      <Link href ="/service-details">Lodging</Link>
                    </h6>
                    <div className="amount-details">
                      <div className="amount">
              ...
              <div className="blog-widget">
                ...
                <div className="bloglist-content">
                  <div className="card-body">
                    ...
                    <h6>
                      <Link href ="/service-details">Outdoors</Link>
                    </h6>
                    <div className="amount-details">
                      <div className="amount">
              ...
              <div className="blog-widget">
                ...
                <div className="bloglist-content">
                  <div className="card-body">
                    ...
                    <h6>
                      <Link href ="/service-details">Automotive</Link>
                    </h6>
                    <div className="amount-details">
                      <div className="amount">
