                            ...
                            <div className="row sorting-div">
                                ...
                                <div className="col-lg-8 col-sm-8  align-items-center">
                                    ...
                                    <div className="grid-listview">
                                        <ul>
                                            <li>
                                                <Link href ="/listing-list-sidebar" className="active">
                                            ...
                                            <div className="card-body">
                                                <div className="blogfeaturelink">
                                                    ...
                                                    <div className="blog-author">
                                                        ...
                                                        <Link href ="#">Eve Leroy</Link>
                                                    </div>
                                                </div>
                                                <h6>
                                                    <Link href ="/service-details">Fashion Luxury Men Date</Link>
                                                </h6>
                                                <div className="blog-location-details">
                                                    <div className="location-info">
                                                        <i className="feather-map-pin" /> Los Angeles
