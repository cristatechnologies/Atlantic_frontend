          ...
          <div className="row">
            <div className="col-sm-12">
                ...
                <div className="col-md-8">
                  <div className="faq-tabs-blk mb-50">
                    <ul className="nav tabs-style gap-3" data-bs-tabs="tabs">
                      ...
                      <li>
                        <Link data-bs-toggle="tab" href ="#FAQpayments"className={toggleState === 2?"active":""} onClick={()=>toggleTap(2)}>
                          Payments
                        </Link>
                      </li>
                      <li>
                        <Link data-bs-toggle="tab" href ="#FAQtrip" className={toggleState === 3?"active":""} onClick={()=>toggleTap(3)}>
                          trip
                        </Link>
                      </li>
                      <li>
                        <Link data-bs-toggle="tab" href ="#FAQguide" className={toggleState === 4?"active":""} onClick={()=>toggleTap(4)}>
                          guide
                        </Link>
                      </li>
                      <li>
                        <Link data-bs-toggle="tab" href ="#FAQcancel" className={toggleState === 5?"active":""} onClick={()=>toggleTap(5)}>
                          cancel
                        </Link>
                      </li>
                    </ul>
              ...
              <div className="btm-style">
                <Link href ="#price" className="price-down">
                  <span>
