              ...
              <div className="col-lg-12">
                <div className="recommended-tabs-blk">
                  <ul className="nav tabs-style gap-3" data-bs-tabs="tabs">
                    ...
                    <li>
                      <Link data-bs-toggle="tab" href ="#Blogrestaurants" className={toggleState === 2?"active":""} onClick={()=>toggleTap(2)}>
                        <span>
                    ...
                    <li>
                      <Link data-bs-toggle="tab" href ="#Blogshops" className={toggleState === 3?"active":""} onClick={()=>toggleTap(3)}>
                        <span>
                    ...
                    <li>
                      <Link data-bs-toggle="tab" href ="#Blogbusiness" className={toggleState === 4?"active":""} onClick={()=>toggleTap(4)}>
                        <span>
                    ...
                    <li>
                      <Link data-bs-toggle="tab" href ="#Bloglifestyle" className={toggleState === 5?"active":""} onClick={()=>toggleTap(5)}>
                        <span>
