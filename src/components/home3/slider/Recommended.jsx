              ...
              <div className="col-lg-12">
                <div className="recommended-tabs-blk">
                  <ul className="nav tabs-style gap-3" data-bs-tabs="tabs">
                    ...
                    <li>
                      <Link data-bs-toggle="tab" href ="#restaurants" onClick={()=>toggleTap(2)} className={toggleState === 2?"active":""}>
                        <span>
                    ...
                    <li>
                      <Link data-bs-toggle="tab" href ="#shops" onClick={()=>toggleTap(3)} className={toggleState === 3?"active":""}>
                        <span>
                    ...
                    <li>
                      <Link data-bs-toggle="tab" href ="#business" onClick={()=>toggleTap(4)} className={toggleState === 4?"active":""}>
                        <span>
                    ...
                    <li>
                      <Link data-bs-toggle="tab" href ="#lifestyle" onClick={()=>toggleTap(5)} className={toggleState === 5?"active":""}>
                        <span>
