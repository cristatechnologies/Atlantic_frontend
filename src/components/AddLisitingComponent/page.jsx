...
const AddListingComponent = () => {
  useEffect(() => {
    // Initialize Tagify on the input field after the component mounts
    const input = document.querySelector("#products");
    new Tagify(input, {
      delimiters: ",", // Use comma as the delimiter
      pattern: /[^,]+/, // Only allow non-comma characters
      dropdown: {
        enabled: 0, // Disable the dropdown suggestions
      },
    });
  }, []);
  return (
