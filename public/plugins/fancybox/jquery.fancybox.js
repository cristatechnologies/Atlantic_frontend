  ...
  var defaults = {
    ...
    video: {
      tpl:
        ...
        'Sorry, your browser doesn\'t support embedded videos, <Link href ="{{src}}">download</Link> and watch with your favorite video player!' +
        "</video>",
  ...
  $.extend(FancyThumbs.prototype, {
    ...
    create: function () {
      ...
      $.each(instance.group, function (i, item) {
        ...
        list.push(
          '<Link href ="javascript:;" tabindex="0" data-index="' +
            i +
            '"' +
            (src && src.length
